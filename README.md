...
- **Recipe search** — powered by the Spoonacular API; horizontal card browse with images, ingredients, and step-by-step instructions; respects your dietary preferences (Vegan, Gluten Free, Dairy Free, etc.) automatically
...
- **Taste profile** — Vivian learns your preferences over time from saves and ratings; she occasionally asks quick questions ("Do you like fish? Often / Sometimes / Rarely / Never") to refine her recommendations; edit everything manually via the Taste Profile screen, which walks you through a 25-ingredient quiz (❤️ Love it / 👍 Like it / 😐 Neutral / 👎 Dislike) — the quiz resumes from where you left off on re-open, or shows a completion screen if all 25 are answered; a separate Cuisine Preferences screen lets you adjust affinity sliders for all 26 cuisines in the recommendation graph; ingredient ratings feed directly into Vivian's recommendation engine (e.g. loving Fish steers picks toward Japanese/Mediterranean, disliking Spicy food steers away from Thai/Indian/Mexican)
