...
public class CuisinePreferencesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar toolbar = findViewById(R.id.cuisinePrefsToolbar);
        setSupportActionBar(toolbar);
        if (getSupportActionBar() != null) {
            getSupportActionBar().setDisplayHomeAsUpEnabled(true);
            getSupportActionBar().setTitle("Cuisine Preferences");
        }
        ...
        saveButton.setOnClickListener(v -> {
            ...
            Toast.makeText(this, "Cuisine preferences saved", Toast.LENGTH_SHORT).show();
            finish();
        });
    }
