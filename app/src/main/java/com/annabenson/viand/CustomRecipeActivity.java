...
public class CustomRecipeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar toolbar = findViewById(R.id.customRecipeToolbar);
        setSupportActionBar(toolbar);
        if (getSupportActionBar() != null) {
            getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        }

        titleField = findViewById(R.id.customTitle);
        ingredientsField = findViewById(R.id.customIngredients);
        instructionsField = findViewById(R.id.customInstructions);
        saveButton = findViewById(R.id.saveCustomRecipeButton);
        deleteButton = findViewById(R.id.deleteCustomRecipeButton);
